...
LangString UninstLogModified ${LANG_GERMAN} "Die Datei $R0 wurde  seit der Installation verÃ¤ndert.  MÃ¶chten Sie diese Datei und alle anderen modifizierten Dateien des Skript Pakets entfernen?$\r$\nOriginal: $R3$\r$\nAktuell: $R4"
